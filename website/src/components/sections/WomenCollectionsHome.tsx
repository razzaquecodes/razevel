...
export default function WomenCollectionsHome() {
      ...
      <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto' }}>
        ...
        <div ref={ref} style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <motion.h2
              ...
              Women's <em style={{ color: 'var(--warm-gold)' }}>Collection.</em>
            </motion.h2>
          </div>
          <motion.div
          ...
          >
            <Link href="/collections/women" className="btn btn-ghost">
              Explore All Women's →
            </Link>
          </motion.div>
        </div>
        ...
        <div style={{
          display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2rem'
            ...
            {MOCK_PRODUCTS.filter(p => p.gender === 'women').slice(0, 4).map((prod, i) => (
